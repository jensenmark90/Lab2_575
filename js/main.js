...
function setMap(){
    ...
    function callback(error, csvData, usa, colorado){
        ...
        var usa = topojson.feature(usa, usa.objects.USA).features,
            coloradoCounties = topojson.feature(colorado, colorado.objects.Colorado).features;
        console.log(usa);
...
function joinData(coloradoCounties, csvData){
    for (var i=0; i<csvData.length; i++){
        ...
        var csvKey = csvCounty.CountyName; //the CSV primary key
        ...
        for (var a=0; a<coloradoCounties.length; a++){
            ...
            var geojsonKey = geojsonProps.CountyName; //the geojson primary key
